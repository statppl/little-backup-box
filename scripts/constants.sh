...
const_FILE_EXTENSIONS_LIST_VIDEO="avi;lrv;mp4;mov;m4v;mts;m2ts;3gp"
...
const_METADATA_DATE_CREATE_SOURCES="XMP:CreateDate;XMP:DateCreated;XMP-photoshop:DateCreated;XMP-exif:DateTimeOriginal;Composite:SubSecCreateDate;Composite:SubSecDateTimeOriginal;EXIF:CreateDate;EXIF:DateTimeOriginal;EXIF:DateTimeDigitized;Composite:DateTimeCreated;QuickTime:CreateDate;QuickTime:MediaCreateDate;QuickTime:TrackCreateDate;QuickTime:ContentCreateDate;RIFF:DateTimeOriginal;RIFF:DateTimeDigitized;PNG:CreationTime;File:FileCreateDate;File:FileModifyDate"
const_METADATA_DATE_CREATE_SOURCES_HR="Create_Date;Date_Created;Date_Time_Original;Sub_Sec_Create_Date;Sub_Sec_Date_Time_Original;Date_Time_Digitized;Date_Time_Created;Media_Create_Date;Track_Create_Date;Content_Create_Date;Creation_Time;File_Creation_Date_Time;File_Modification_Date_Time"
...
const_PASSWORDS_LIST='conf_PASSWORD;conf_WIFI_PASSWORD;conf_MAIL_PASSWORD;conf_RSYNC_PASSWORD;conf_SMB_PASSWORD;conf_SOCIAL_BLUESKY_APP_PASSWORD'
